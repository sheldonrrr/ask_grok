...
class SpanishTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': 'Se ha añadido «{0}» correctamente. ¿Deseas establecerla como la IA predeterminada?',
            ...
            'about_markdown_desc': 'Exporta libros como archivos de texto Markdown.',
            'about_tradsimp_title': 'Conversión de chino para calibre',
            ...
            'model_display_name_custom': 'Personalizado (compatible con OpenAI)',
            ...
            'custom_openai_compat_notice': 'Nota: Custom usa el formato OpenAI Chat Completions (/chat/completions). Introduzca una Base URL y un nombre de modelo compatibles. La API Key es opcional en algunos servidores locales.',
            'local_openai_compat_no_api_key_notice': 'Nota: este servicio local compatible con OpenAI normalmente no requiere una API Key. Inicie el servidor local y luego actualice la lista de modelos.',
            'lmstudio_no_api_key_notice': 'Nota: LM Studio usa localmente la API compatible con OpenAI y normalmente no requiere una API Key.',
            'koboldcpp_no_api_key_notice': 'Nota: KoboldCpp usa localmente la API compatible con OpenAI y normalmente no requiere una API Key.',
            'local_service_not_running': 'No se puede conectar al servicio de IA local. Confirme que está en ejecución y que la Base URL es correcta.',
            ...
            'base_url_desc_kimi': 'Las claves internacionales usan https://api.moonshot.ai/v1; las de la plataforma de China usan https://api.moonshot.cn/v1. No las mezcles.',
            'kimi_region_label': 'Plataforma',
            'kimi_region_global': 'Internacional',
            'kimi_region_china': 'China continental',
            'kimi_base_url_readonly_tip': 'La URL base la determina la plataforma seleccionada.',
