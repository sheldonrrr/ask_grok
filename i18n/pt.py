...
class PortugueseTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': '«{0}» foi adicionada com sucesso. Deseja defini-la como a IA padrão?',
            ...
            'model_display_name_custom': 'Personalizado (compatível com OpenAI)',
            ...
            'custom_openai_compat_notice': 'Nota: Custom usa o formato OpenAI Chat Completions (/chat/completions). Informe uma Base URL e um nome de modelo compatíveis. A API Key é opcional em alguns servidores locais.',
            'local_openai_compat_no_api_key_notice': 'Nota: este serviço local compatível com OpenAI geralmente não requer uma API Key. Inicie o servidor local e depois atualize a lista de modelos.',
            'lmstudio_no_api_key_notice': 'Nota: o LM Studio usa localmente a API compatível com OpenAI e geralmente não requer uma API Key.',
            'koboldcpp_no_api_key_notice': 'Nota: o KoboldCpp usa localmente a API compatível com OpenAI e geralmente não requer uma API Key.',
            'local_service_not_running': 'Não foi possível conectar ao serviço de IA local. Confirme se ele está em execução e se a Base URL está correta.',
            ...
            'base_url_desc_kimi': 'Chaves internacionais usam https://api.moonshot.ai/v1; chaves da plataforma da China usam https://api.moonshot.cn/v1. Não as misture.',
            'kimi_region_label': 'Plataforma',
            'kimi_region_global': 'Internacional',
            'kimi_region_china': 'China continental',
            'kimi_base_url_readonly_tip': 'A URL base é determinada pela plataforma selecionada.',
