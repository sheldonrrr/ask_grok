...
class NorwegianTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': '"{0}" er lagt til. Vil du angi den som standard-AI?',
            ...
            'about_related_plugins': 'Relaterte programtillegg',
            ...
            'model_display_name_custom': 'Egendefinert (OpenAI-kompatibel)',
            ...
            'custom_openai_compat_notice': 'Merk: Custom bruker OpenAI Chat Completions-formatet (/chat/completions). Angi en kompatibel Base URL og modellnavn. API-nøkkel er valgfri for noen lokale tjenere.',
            'local_openai_compat_no_api_key_notice': 'Merk: Denne lokale OpenAI-kompatible tjenesten trenger vanligvis ikke en API-nøkkel. Start den lokale serveren, og oppdater deretter modellisten.',
            'lmstudio_no_api_key_notice': 'Merk: LM Studio bruker lokalt OpenAI-kompatibel API og trenger vanligvis ikke en API-nøkkel.',
            'koboldcpp_no_api_key_notice': 'Merk: KoboldCpp bruker lokalt OpenAI-kompatibel API og trenger vanligvis ikke en API-nøkkel.',
            'local_service_not_running': 'Kan ikke koble til den lokale AI-tjenesten. Bekreft at den kjører og at Base URL er riktig.',
            ...
            'base_url_desc_kimi': 'Internasjonale nøkler bruker https://api.moonshot.ai/v1; Kina-plattformnøkler bruker https://api.moonshot.cn/v1. Ikke bland dem.',
            'kimi_region_label': 'Plattform',
            'kimi_region_global': 'Internasjonal',
            'kimi_region_china': 'Kina (fastlandet)',
            'kimi_base_url_readonly_tip': 'Base-URL bestemmes av den valgte plattformen.',
