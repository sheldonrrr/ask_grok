...
class DutchTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'enable_debug_logging': 'Debug-logging inschakelen (ask_ai_plugin_debug.log)',
            'debug_logging_hint': 'Wanneer uitgeschakeld, worden debug-logs niet naar het bestand geschreven. Dit kan voorkomen dat het logbestand te groot wordt.',
