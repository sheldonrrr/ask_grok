...
class DutchTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': '"{0}" is succesvol toegevoegd. Wilt u dit als standaard-AI instellen?',
            ...
            'model_display_name_custom': 'Aangepast (OpenAI-compatibel)',
            'model_display_name_ollama': 'Ollama(Lokaal)',
            'model_display_name_lmstudio': 'LM Studio(Lokaal)',
            'model_display_name_koboldcpp': 'KoboldCpp(Lokaal)',
            'custom_openai_compat_notice': 'Let op: Custom gebruikt het OpenAI Chat Completions-formaat (/chat/completions). Voer een compatibele Base URL en modelnaam in. API-sleutel is optioneel voor sommige lokale servers.',
            'local_openai_compat_no_api_key_notice': 'Let op: deze lokale OpenAI-compatibele dienst heeft meestal geen API-sleutel nodig. Start de lokale server en vernieuw daarna de modellijst.',
            'lmstudio_no_api_key_notice': 'Let op: LM Studio gebruikt lokaal de OpenAI-compatibele API en heeft meestal geen API-sleutel nodig.',
            'koboldcpp_no_api_key_notice': 'Let op: KoboldCpp gebruikt lokaal de OpenAI-compatibele API en heeft meestal geen API-sleutel nodig.',
            'local_service_not_running': 'Kan geen verbinding maken met de lokale AI-dienst. Controleer of deze draait en of de Base URL correct is.',
            ...
            'base_url_desc_kimi': 'Internationale sleutels gebruiken https://api.moonshot.ai/v1; China-platformsleutels gebruiken https://api.moonshot.cn/v1. Meng ze niet.',
            'kimi_region_label': 'Platform',
            'kimi_region_global': 'Internationaal',
            'kimi_region_china': 'China (vasteland)',
            'kimi_base_url_readonly_tip': 'De basis-URL wordt bepaald door het geselecteerde platform.',
