...
class EnglishTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': 'You have successfully added "{0}". Would you like to set it as the default AI?',
            ...
            'about_open_nowtiny': 'Open Nowtiny',
            'about_nowtiny_note': 'More tools and plugin status are on Nowtiny.',
            ...
            'model_display_name_custom': 'Custom (OpenAI Compatible)',
            ...
            'custom_openai_compat_notice': 'Note: Custom uses the OpenAI Chat Completions format (/chat/completions). Enter a compatible Base URL and model name. API Key is optional for some local servers.',
            ...
            'kimi_region_china': 'China Mainland',
