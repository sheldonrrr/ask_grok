...
class DanishTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': '"{0}" er tilføjet. Vil du indstille den som standard-AI?',
            ...
            'question_too_long_reduce_books': 'For at sammenligne et mindre sæt i dybden, prøv at fravælge ca. {count} bog/bøger.',
            ...
            'model_display_name_custom': 'Brugerdefineret (OpenAI-kompatibel)',
            ...
            'custom_openai_compat_notice': 'Bemærk: Custom bruger OpenAI Chat Completions-formatet (/chat/completions). Angiv en kompatibel Base URL og modelnavn. API-nøgle er valgfri for nogle lokale servere.',
            'local_openai_compat_no_api_key_notice': 'Bemærk: Denne lokale OpenAI-kompatible tjeneste kræver normalt ikke en API-nøgle. Start den lokale server, og opdater derefter modellisten.',
            'lmstudio_no_api_key_notice': 'Bemærk: LM Studio bruger lokalt den OpenAI-kompatible API og kræver normalt ikke en API-nøgle.',
            'koboldcpp_no_api_key_notice': 'Bemærk: KoboldCpp bruger lokalt den OpenAI-kompatible API og kræver normalt ikke en API-nøgle.',
            'local_service_not_running': 'Kan ikke oprette forbindelse til den lokale AI-tjeneste. Bekræft, at den kører, og at Base URL er korrekt.',
            ...
            'base_url_desc_kimi': 'Internationale nøgler bruger https://api.moonshot.ai/v1; Kina-platformnøgler bruger https://api.moonshot.cn/v1. Bland dem ikke.',
            'kimi_region_label': 'Platform',
            'kimi_region_global': 'International',
            'kimi_region_china': 'Kina (fastlandet)',
            'kimi_base_url_readonly_tip': 'Base-URL bestemmes af den valgte platform.',
            ...
            'ai_search_data_subtitle': 'Opdater den kompakte bogliste sendt til AI, når du tilføjer eller fjerner bøger',
