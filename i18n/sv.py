...
class SwedishTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'enable_debug_logging': 'Aktivera felsökningsloggning (ask_ai_plugin_debug.log)',
            'debug_logging_hint': 'När inaktiverad kommer felsökningsloggar inte att skrivas till fil. Detta kan förhindra att loggfilen blir för stor.',
