...
class SwedishTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': '"{0}" har lagts till. Vill du ställa in den som standard-AI?',
            ...
            'model_display_name_custom': 'Anpassad (OpenAI-kompatibel)',
            ...
            'custom_openai_compat_notice': 'Obs: Custom använder OpenAI Chat Completions-formatet (/chat/completions). Ange en kompatibel Base URL och modellnamn. API-nyckel är valfri för vissa lokala servrar.',
            'local_openai_compat_no_api_key_notice': 'Obs: Denna lokala OpenAI-kompatibla tjänst kräver vanligtvis ingen API-nyckel. Starta den lokala servern och uppdatera sedan modelllistan.',
            'lmstudio_no_api_key_notice': 'Obs: LM Studio använder lokalt det OpenAI-kompatibla API:t och kräver vanligtvis ingen API-nyckel.',
            'koboldcpp_no_api_key_notice': 'Obs: KoboldCpp använder lokalt det OpenAI-kompatibla API:t och kräver vanligtvis ingen API-nyckel.',
            'local_service_not_running': 'Kan inte ansluta till den lokala AI-tjänsten. Bekräfta att den körs och att Base URL är korrekt.',
            ...
            'base_url_desc_kimi': 'Internationella nycklar använder https://api.moonshot.ai/v1; Kina-plattformsnycklar använder https://api.moonshot.cn/v1. Blanda dem inte.',
            'kimi_region_label': 'Plattform',
            'kimi_region_global': 'Internationell',
            'kimi_region_china': 'Kina (fastlandet)',
            'kimi_base_url_readonly_tip': 'Bas-URL bestäms av den valda plattformen.',
