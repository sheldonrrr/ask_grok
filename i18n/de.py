...
class GermanTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'web_search_button_tooltip': 'Search the web with Brave Search and let AI decide whether to search again or answer. Bind your Brave API key in Settings → Search.',
            ...
            'web_search_missing_key': 'Web Search is on, but no Brave Search API key is configured. Open Configuration → Search and paste your Brave API key.',
            'web_search_invalid_key': 'Brave Search rejected the API key (HTTP {status}). Check the key and your Brave plan in Settings → Search.',
