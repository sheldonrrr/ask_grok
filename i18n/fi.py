...
class FinnishTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'set_default_ai_after_add_message': '"{0}" on lisätty. Haluatko asettaa sen oletustekoälyksi?',
            ...
            'model_display_name_custom': 'Mukautettu (OpenAI-yhteensopiva)',
            'model_display_name_ollama': 'Ollama(Paikallinen)',
            'model_display_name_lmstudio': 'LM Studio(Paikallinen)',
            'model_display_name_koboldcpp': 'KoboldCpp(Paikallinen)',
            'custom_openai_compat_notice': 'Huom: Custom käyttää OpenAI Chat Completions -muotoa (/chat/completions). Anna yhteensopiva Base URL ja mallinimi. API-avain on valinnainen joillakin paikallisilla palvelimilla.',
            'local_openai_compat_no_api_key_notice': 'Huom: tämä paikallinen OpenAI-yhteensopiva palvelu ei yleensä tarvitse API-avainta. Käynnistä paikallinen palvelin ja päivitä sitten mallilista.',
            'lmstudio_no_api_key_notice': 'Huom: LM Studio käyttää paikallisesti OpenAI-yhteensopivaa rajapintaa eikä yleensä tarvitse API-avainta.',
            'koboldcpp_no_api_key_notice': 'Huom: KoboldCpp käyttää paikallisesti OpenAI-yhteensopivaa rajapintaa eikä yleensä tarvitse API-avainta.',
            'local_service_not_running': 'Paikalliseen AI-palveluun ei saada yhteyttä. Varmista, että se on käynnissä ja Base URL on oikein.',
            ...
            'base_url_desc_kimi': 'Kansainväliset avaimet käyttävät https://api.moonshot.ai/v1; Kiinan alustan avaimet käyttävät https://api.moonshot.cn/v1. Älä sekoita niitä.',
            'kimi_region_label': 'Alusta',
            'kimi_region_global': 'Kansainvälinen',
            'kimi_region_china': 'Manner-Kiina',
            'kimi_base_url_readonly_tip': 'Perus-URL määräytyy valitun alustan mukaan.',
