...
class FinnishTranslation(BaseTranslation):
    ...
    def translations(self) -> dict:
        return {
            ...
            'enable_debug_logging': 'Ota virheenkorjausloki käyttöön (ask_ai_plugin_debug.log)',
            'debug_logging_hint': 'Kun poistettu käytöstä, virheenkorjauslokit eivät kirjoitu tiedostoon. Tämä voi estää lokitiedoston kasvamisen liian suureksi.',
