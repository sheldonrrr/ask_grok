...
Latest updated: Sep 10, 2026, Ask AI Plugin v1.6.3
...
- Default model in the plugin: `nvidia/nemotron-3-nano-30b-a3b`
- Limit: About 40 requests per minute (varies by Nvidia plan)
